...
#Originally I thought I needed the pscx toolset for the format-xml thing, but apparently I'm just a fucking idiot and don't know how to fetch Object data in powershell.
#This has 3 steps: Find the Job Options XML from a selected Job log, grab the most recent copy from the array, clean up the data to pack into an XML object, pack it into $JobSettings.
